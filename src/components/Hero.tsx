    ...
    <section className="w-full px-4 pt-4 pb-20">
      ...
      >
        ...
        <div className="relative rounded-xl border-2 border-black overflow-hidden">
          {/* Wallpaper Image */}
          <div className="relative w-full aspect-[16/11] md:aspect-[16/5]">
            <Image
              src="/mountain.jpg"
      ...
      <div className="text-center mt-5 md:mt-8">
        ...
        >
          ...
          <a
            href="https://x8izujfcrrgmft6e.public.blob.vercel-storage.com/releases/Oak-1.0.13.dmg?b=17"
            download="Oak-1.0.13.dmg"
