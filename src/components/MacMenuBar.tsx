...
export function MacMenuBar({ children }: MacMenuBarProps) {
  return (
    <div className="relative w-full h-7">
      {/* Menu Bar Background */}
      <div className="absolute inset-x-0 top-0 h-7 bg-black/80 backdrop-blur-xl flex items-center justify-between px-4 text-white text-xs" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", "Helvetica Neue", sans-serif' }}>
